 ...
 * Style
 */
import './F2xBecomePlatinumMember.css';
	...
	render(){
		return (
			<div className="cuerpo">
				<div className="f2x-modal-title">BECOME A <br />PLATINUM MEMBER</div>
				...
				<div style={{fontSize: '14px', margin: '12px auto 0 auto', width: '220px'}}>
					Unlimited online streaming access to all F2X content 
				</div>
...
const mapStateToProps = (state) => {
	const {modal, workouts, card} = state;
					...
					ModalTypes.GENERIC, 
					{
						...
						content: (
							<div className="f2x-moda-generic-content">
								<center>
									<img src={ICON_OK} alt="successful" width="90" />
								</center>
								<br />
								Platinum subscription successful buy
							</div>
						),
						btn: () => {
